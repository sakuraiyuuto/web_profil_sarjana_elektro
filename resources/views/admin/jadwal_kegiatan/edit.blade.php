                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Data Jadwal Kegiatan</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form class="from-prevent-multiple-submits"
                                        ...
                                        @csrf
                                        <div class="card-body">
                                            <input type="hidden" value="{{ $jadwalKegiatan->id }}" name="id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="teks" placeholder="Masukkan Deskripsi"
                                                    name="teks">{{ $jadwalKegiatan->teks }}</textarea>
                                            </div>
                                            <div class="form-group mt-2">
                                                <label for="release_date">Tanggal Rilis</label>
                                                <input type="date" class="form-control mt-0" name="release_date"
                                                    value="{{ $jadwalKegiatan->release_date }}" required>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
