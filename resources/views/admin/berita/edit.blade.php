                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form class="from-prevent-multiple-submits"
                                        action="{{ route('berita.update', $berita) }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <img src="{{ url($berita->thumbnail) }}" alt="Image Missing"
