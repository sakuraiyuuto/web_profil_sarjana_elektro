                                        ...
                                        <tbody>
                                            @foreach ($hakis as $haki)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($haki->nama_file != '')
                                                            <a href="{{ url($haki->nama_file) }}" download
                                                                target="_blank">{{ $haki->nama_file }}</a>
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    ...
                                                    @if ($haki->deleted_at == '')
                                                        <td>
                                                            ...
                                                            <form action="{{ route('haki.destroy', $haki) }}"
                                                                method="post">
                                                                @method('delete')
                                                                @csrf
    ...
    <div class="modal fade" id="formModalAdd" tabindex="-1" aria-labelledby="formModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formAdd" action="{{ url('/admin/haki') }}" method="post" enctype="multipart/form-data">
                    @csrf
