...
@section('title', 'Repository Skripsi - Sarjana Teknik Elektro UNTAN')
                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Detail Repository Skripsi</h3>
                        </div>

                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a href="{{ url('/repository_skripsi') }}">Repository Skripsi</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>{{ $repositorySkripsi->judul }}</h5>
                                </div>

                                <ul class="blog_detail_meta">
                                    <li><i class="fa fa-calendar"></i><a
                                            href="#">{{ date('d M, Y', strtotime($repositorySkripsi->release_date)) }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
                                    <li><a href="#">Author : {{ $repositorySkripsi->author }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
                                    <li><a href="#">Tahun : {{ $repositorySkripsi->tahun }}</a>
                                    </li>
                                </ul>

                                <h5>Abstrak : </h5><br>

                                <p>{!! $repositorySkripsi->teks !!}
