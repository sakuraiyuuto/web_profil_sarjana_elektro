...
@section('title', 'Sidang Akhir - Sarjana Teknik Elektro UNTAN')
                    ...
                    <div class="col-md-8">
                        <div class="abt_univ_wrap">
                            ...
                            <div class="kf_edu2_heading1">
                                <h3>Sidang Akhir Prodi Sarjana Teknik Elektro</h3>
                            </div>
                            <!-- HEADING 1 END-->
                            ...
                            <div class="download_btn">
                                <b>Dokumen : </b>
                                <a target="_blank" href="{{ url($sidangAkhir->nama_file) }}" download
