...
@section('title', 'Repository Kerja Praktik - Sarjana Teknik Elektro UNTAN')
                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Repository Kerja Praktik</h3>
                        </div>

                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a>Repository Kerja Praktik</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            <table id="tabel_repository_kerja_praktik" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Judul</th>
