...
@section('title', 'Kerjasma Mitra Kolaborasi')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Kerjasma Mitra Kolaborasi</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Data Kerjasma Mitra Kolaborasi</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form class="from-prevent-multiple-submits"
                                        action="{{ route('kerjasama_mitra_kolaborasi.update', $kerjasamaMitraKolaborasi) }}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="release_date"
                                                    value="{{ $kerjasamaMitraKolaborasi->release_date }}" required>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
