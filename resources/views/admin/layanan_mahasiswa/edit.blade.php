                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Data Layanan Mahasiswa</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form class="from-prevent-multiple-submits"
                                        action="{{ route('layanan_mahasiswa.update', $layananMahasiswa) }}" method="POST"
                                        enctype="multipart/form-data">
                                        @method('patch')
                                        @csrf
                                        <div class="card-body">
                                            <input type="hidden" value="{{ $layananMahasiswa->id }}" name="id">
                                            <div class="form-group">
                                                <label for="judul">Judul</label>
                                                <input type="text" class="form-control" id="judul" name="judul"
                                                    maxlength="255" placeholder="Masukkan Judul"
                                                    value="{{ $layananMahasiswa->judul }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="thumbnail">Thumbnail (Maksimal 2MB)</label>
                                                <div class="form-group">
                                                    <img src="{{ url($layananMahasiswa->thumbnail) }}" alt="Image Missing"
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <input type="date" class="form-control mt-0" name="release_date"
                                                    value="{{ $layananMahasiswa->release_date }}" required>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
